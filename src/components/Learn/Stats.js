				...
				<main className="stats">
					...
					<section className="stats-mastery">
						...
						<div className="stats-mastery-chart">
							<div className="stats-mastery-chart-bar__container">
								<div
									style={{ width: (percentUnseen > 15 ? percentUnseen : 15) + '%' }}
									className="stats-mastery-chart-bar stats-mastery-chart-bar__unseen"
								>
									<p className="stats-mastery-chart-bar__percentage">{percentUnseen}%</p>
								</div>
								<p className="stats-mastery-chart-text">New</p>
							</div>
							<div
								style={{ width: (percentLearning > 15 ? percentLearning : 15) + '%' }}
								className="stats-mastery-chart-bar__container"
							>
								<div className="stats-mastery-chart-bar stats-mastery-chart-bar__learning">
									<p className="stats-mastery-chart-bar__percentage">{percentLearning}%</p>
								</div>
							...
							<div className="stats-mastery-chart-bar__container">
								<div
									...
									style={{ width: (percentMastered > 15 ? percentMastered : 15) + '%' }}
								>
									<p className="stats-mastery-chart-bar__percentage">{percentMastered}%</p>
								</div>
					...
					<section className="stats-fun-facts">
						...
						<div className="stats-fun-facts-fact">
							<p>
								<span className="stats-fun-facts-fact__title">Total cards answered:</span>{' '}
								<span className="stats-fun-facts-fact__num">{cardsAnswered}</span> cards
							</p>
						</div>
						<div className="stats-fun-facts-fact">
							<p>
								<span className="stats-fun-facts-fact__title">Longest correct streak:</span>{' '}
								<span className="stats-fun-facts-fact__num">{maxStreak}</span> cards correct
							</p>
						</div>
						<div className="stats-fun-facts-fact">
							<p>
								<span className="stats-fun-facts-fact__title">Current correct streak:</span>{' '}
								<span className="stats-fun-facts-fact__num">{streak}</span> cards correct
							</p>
						</div>
					</section>
				</main>
